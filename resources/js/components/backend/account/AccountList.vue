  ...
  <div class="container">
    <div class="w-full">
      <title-section
        ...
        :subtitle="'Semua informasi terkait akun admin website sekolah'"
      ></title-section>
        ...
        <div class="w-full border border-grey-light p-8 bg-white rounded">
          ...
          <table class="table-auto block">
            ...
            <tbody>
              ...
              <tr
                vue-if="!isLoading && accounts.length > 0"
      ...
      <modal name="add-account" class="rounded" height="auto" :scrollable="true">
        <div class="p-6">
          <div class="text-xl block w-full font-semibold mb-1 pb-4 border-b border-grey-light">
            <i class="fa fa-info-circle text-grey-dark"/> Tambah data siswa
          </div>
          <div class="flex">
            <div class="w-1/2">
      ...
      <modal name="edit-account" class="rounded" height="auto" :scrollable="true">
        <div class="p-6">
          <div class="text-xl block w-full font-semibold mb-1 pb-4 border-b border-grey-light">
            <i class="fa fa-info-circle text-grey-dark"/> Ubah data guru
          </div>
          <div class="flex">
            <div class="w-1/2">
              <small class="label mt-6">Nama</small>
...
export default {
  ...
  methods: {
    ...
    submitData() {
      ...
      axios
        .post("/api/submit-account/", { data: this.new_data })
        .then(res => {
    ...
    updateData() {
      ...
      axios
        .post("/api/update-account/", { data: this.edit_data })
        .then(res => {
          if (res.data.error == "validation") {
            this.isLoadingButton = false;
          } else {
